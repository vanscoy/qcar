...
# Helper object to find speed and distance of a give qcar
class speedCalc:
	...
	# Return the speed (m/s) found in between function calls
	...
	# Return the distance (m) traveled in between function calls
