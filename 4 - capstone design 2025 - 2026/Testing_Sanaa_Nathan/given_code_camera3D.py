...
counter = 0
# max_distance_view = 5
max_distance = 10 # pixels in RGB image farther than this will appear white  
min_distance = 0.000004 # pixels in RGB image closer than this will appear black
...
try:
    while elapsed_time() < simulationTime:
        ...
        msSleepTime = int(50000*sleepTime)
        if msSleepTime <= 0:
            msSleepTime = 1
